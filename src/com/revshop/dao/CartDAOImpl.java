...
public class CartDAOImpl implements ICartDAO {
    ...
    public java.util.List<com.revshop.model.CartItem> getCartItems(int userId) {
        java.util.List<com.revshop.model.CartItem> items = new java.util.ArrayList<>();
        String sql = "SELECT * FROM cart_items WHERE cart_id=(SELECT cart_id FROM carts WHERE user_id=?)";
        ...
        try (Connection con = JDBCUtil.getConnection();
             ...
             ResultSet rs = ps.executeQuery();
             while (rs.next()) {
                 com.revshop.model.CartItem item = new com.revshop.model.CartItem();
